...
| Dashboard shows discovered companies and personas | Implemented | Leads and Prospects tabs, `icp_engine/web_assets/seed-companies.json`, screenshots `01_leads.jpg`, `02_prospects.jpg`, `make e2e-smoke` | Prospect/persona export available as CSV/JSON. The deployed seed universe contains 328 accounts, including 224 Volaris portfolio companies, 100 Harris portfolio companies, and ICP examples such as Mojio, Automate, Hootsuite, and Geotab. |
